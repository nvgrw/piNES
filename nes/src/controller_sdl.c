...
void controller_sdl_button(SDL_Event event) {
  ...
  switch (event.key.keysym.sym) {
    case SDLK_k:         ctrl1_state.a = v;      break;
    case SDLK_j:         ctrl1_state.b = v;      break;
    case SDLK_BACKSPACE: ctrl1_state.select = v; break;
    case SDLK_RETURN:    ctrl1_state.start = v;  break;
    case SDLK_UP:        // pass through
    case SDLK_w:         ctrl1_state.up = v;     break;
    case SDLK_DOWN:      // pass through
    case SDLK_s:         ctrl1_state.down = v;   break;
    case SDLK_LEFT:      // pass through
    case SDLK_a:         ctrl1_state.left = v;   break;
    case SDLK_RIGHT:     // pass through
    case SDLK_d:         ctrl1_state.right = v;  break;
  }
}
